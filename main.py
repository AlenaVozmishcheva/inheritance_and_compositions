...
print(computer.powersupply.apply_voltage())
print(computer.motherboard.redistribute_the_voltage())
print(computer.cpu.activate_turbo_mode())
print(computer.ram.load_data())
print(computer.ram.unload_data())
print(computer.ssd.save_data())
print(computer.ssd.delete_data())
print(computer.gpu.display_image())